# -*- coding: utf-8 -*-
"""
Обновленная система автоматизации управления товарными запасами
Версия 2.0 с ABC анализом

Автор: AI Assistant  
Описание: Полная автоматизация логики Саната с ABC анализом по категориям
"""
