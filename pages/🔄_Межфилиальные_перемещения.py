...
def main():
    ...
    if stock_file and sales_file:
                    ...
                    if recommendations:
                        ...
                        with col2:
                            ...
                            **🏪 МАГАЗИНЫ 3-ГО УРОВНЯ**
                            - ТД Казыбаева ФУРНИТУРА магазин ← Казыбаева склад
                            - Магазин фурнитуры ← склад № 1 (Астана)
                            - 6 Склад "Овощная база" Магазин ← Шымкент склад
                            """)
        ...
        **Главный хаб:**
        - База Склад Фурнитура Комплект → снабжает все склады
        
        **Склады 2-го уровня:**
        - Казыбаева Склад → ТД Казыбаева магазин
        - склад № 1 (Астана) → Магазин фурнитуры
        - Шымкент склад → Овощная база магазин
