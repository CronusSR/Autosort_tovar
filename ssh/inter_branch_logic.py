...
def parse_sales_data(sales_json):
    ...
    period_days = 30.5  # по умолчанию
    if period_start and period_end:
        period_days = (period_end - period_start).days + 1
    
    return pd.DataFrame(all_sales), period_days

def calculate_simple_ads_from_sales(sales_df, period_days = 30.5):
...
def calculate_turnover_and_ads(stock_df, sales_df, period_days = 30.5):
...
def generate_movement_recommendations(stock_df, sales_df, period_days = 30.5, 
