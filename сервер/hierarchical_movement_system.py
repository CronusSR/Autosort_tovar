...
class HierarchicalMovementSystem:
    def __init__(self):
        # Иерархия складов (правильная структура согласно требованиям)
        ...
        # Нормативы остатков по типам филиалов (в днях) - согласно иерархии
        self.stock_norms = {
            'hub': {'min_days': 30, 'max_days': 90},        # Главный хаб - большие запасы
            'warehouse': {'min_days': 15, 'max_days': 45},  # Склады 2-го уровня  
            'shop': {'min_days': 8, 'max_days': 30}         # Магазины (2-го и 3-го уровней)
        }
